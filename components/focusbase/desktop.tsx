...
export function DesktopSettings(){
  ...
  return <section data-localized className="panel form-stack"><h2><Monitor size={21}/> {en?'ÇalışBase icon':'Иконка ÇalışBase'}</h2>
    {available?<>
      ...
      <p className="muted">{en?'To keep the icon outside the browser, use ÇalışBase Desktop for Windows and enable “Show above other windows”.':'Для иконки за пределами браузера используй ÇalışBase Desktop для Windows и включи «Показывать поверх других окон».'}</p>
